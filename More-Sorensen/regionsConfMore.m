...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ngsol, nevals,nb_iter, xsol, f_xsol, delta_fin,nb_intern ] = regionsConfMore( f, grad_f, hess_f ,x0,nb_max ,delta_0, delta_max, g1,g2,n1,n2,eps )
...
while(critere)
    ...
    [k,sk, ~ ]=More_Sorensen( gk, Hk , delta_k ,nb_max,eps);
    nb_intern=nb_intern+k;
    f_sk=f(xk+sk);
    ...
    % maj evaluations de f, grad_f et hess_f
    neval(1)=neval(1)+1;
